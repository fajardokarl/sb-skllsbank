...
class Waitlist_model extends MY_Model{
    ...
    public function get_applicants(){
        ...
        $this->db->where('applicant.approved', 0);
    ...
    public function get_employers(){
        ...
        $this->db->where('partner.approved', 0);
        $this->db->or_where('partner.approved', 2);
        $this->db->where('partner.profile_complete', 1);
    ...
    public function accept_applicant($applicant){
    ...
    public function reserve_applicant($applicant){
    ...
    public function reject_applicant($applicant){
    ...
    public function accept_company($company){

        $data = array(
            'approved' => 1
        );

        $this->db->where('idx', $company);
        $result = $this->db->update('partner', $data);
        return $result;
    }

    public function reserve_company($company){
    ...
    public function reject_company($company){
