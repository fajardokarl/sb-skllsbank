			...
			<div class="m-portlet__foot">
				<div class="form-group m-form__group">
					<div class="m-form__actions">
						<!-- <a class="btn btn-success" href="<?php echo base_url('kenton/waitlist/accept_applicant/'.$applicant[0]->idx); ?>"><i class="fa fa-check"></i> Accept</a>
						<a class="btn btn-primary" href="<?php echo base_url('kenton/waitlist/reserve_applicant/'.$applicant[0]->idx); ?>"><i class="fa fa-lightbulb"></i> Reserve</a>
						<a class="btn btn-danger" href="<?php echo base_url('kenton/waitlist/reject_applicant/'.$applicant[0]->idx); ?>"><i class="fa fa-times"></i> Reject</a> -->
						<!-- <button type="button" class="btn btn-success"><i class="fa fa-check"></i> Accept</button>
						<button type="button" class="btn btn-danger"><i class="fa fa-times"></i> Reject</button> -->
						<button type="button" class="btn btn-success m-btn m-btn--custom" id="accept_button" data-url="<?php echo base_url('kenton/waitlist/accept_applicant')?>" data-key="<?php echo $applicant[0]->idx;?>"><i class="fa fa-check"></i> Accept</button>
						<button type="button" class="btn btn-primary m-btn m-btn--custom" id="reserve_button" data-url="<?php echo base_url('kenton/waitlist/reserve_applicant')?>" data-key="<?php echo $applicant[0]->idx;?>"><i class="fa fa-lightbulb"></i> Reserve</button>
						<button type="button" class="btn btn-danger m-btn m-btn--custom" id="reject_button" data-url="<?php echo base_url('kenton/waitlist/reject_applicant')?>" data-key="<?php echo $applicant[0]->idx;?>"><i class="fa fa-times"></i> Reject</button>
					</div>
				</div>
			</div>
		</div>
