<div class="m-grid__item m-grid__item--fluid m-grid m-grid--hor-desktop m-grid--desktop m-body">
                    ...
                    <div class="tab-pane active" id="m_tabs_6_1" role="tabpanel">
                        ...
                        <div class="m-accordion m-accordion--bordered" id="m_accordion_2" role="tablist">
                            ...
                            <div class="m-accordion__item">
                                ...
                                <div class="m-accordion__item-body show" id="m_accordion_2_item_2_body" role="tabpanel" aria-labelledby="m_accordion_2_item_2_head" data-parent="#m_accordion_2">
                                    <div class="m-accordion__item-content">
                                        <div class="form-group m-form__group">
                                            <div class="row">
                                                <div class="col-md-4">
                    ...
                    <div class="tab-pane" id="m_tabs_6_2" role="tabpanel">
                        ...
                        <div class="m-accordion m-accordion--bordered" id="m_accordion_2" role="tablist">
                            ...
                            <div class="m-accordion__item">
                                ...
                                <div class="m-accordion__item-body collapse show" id="m_accordion_2_item_1_body" role="tabpanel" aria-labelledby="m_accordion_2_item_1_head" data-parent="#m_accordion_2">
                                    <div class="m-accordion__item-content">
    ...
    <!--end::User profile-->
</div><footer class="m-grid__item  m-footer ">
        ...
        <div class="m-stack m-stack--flex-tablet-and-mobile m-stack--ver m-stack--desktop">
            <div class="m-stack__item m-stack__item--left m-stack__item--middle m-stack__item--last">
                <span class="m-footer__copyright">
                    2017 © Skills Bank by Kenton Chambers
                </span>
            </div>
...
</footer><script src="http://localhost:8080/sb-skills//public/welcome/js/dashboard.js" type="text/javascript"></script>
